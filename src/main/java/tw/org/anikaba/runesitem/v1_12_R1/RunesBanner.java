...
public class RunesBanner  extends RunesMeta implements BannerMeta {
    ...
    RunesBanner(RunesMeta meta) {
        super(meta);

        if (!(meta instanceof RunesBanner)) {
            return;
        }

        RunesBanner banner = (RunesBanner) meta;
        base = banner.base;
        patterns = new ArrayList<Pattern>(banner.patterns);
    }

    RunesBanner(NBTTagCompound tag) {
        super(tag);
    ...
    RunesBanner(Map<String, Object> map) {
        super(map);
    ...
    int applyHash() {
        ...
        return original != hash ? RunesBanner.class.hashCode() ^ hash : hash;
    }
    ...
    public boolean equalsCommon(RunesMeta meta) {
        ...
        if (meta instanceof RunesBanner) {
            RunesBanner that = (RunesBanner) meta;
    ...
    boolean notUncommon(RunesMeta meta) {
        return super.notUncommon(meta) && (meta instanceof RunesBanner || (patterns.isEmpty() && base == null));
    }
