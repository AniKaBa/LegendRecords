...
public class RunesBook extends RunesMeta implements BookMeta {
    ...
    RunesBook(RunesMeta meta) {
        super(meta);

        if (meta instanceof RunesBook) {
            RunesBook bookMeta = (RunesBook) meta;
    ...
    RunesBook(NBTTagCompound tag) {
        this(tag, true);
    }

    RunesBook(NBTTagCompound tag, boolean handlePages) {
        super(tag);
    ...
    RunesBook(Map<String, Object> map) {
        super(map);
    ...
    @Override
    public RunesBook clone() {
        RunesBook meta = (RunesBook) super.clone();
    ...
    int applyHash() {
        ...
        return original != hash ? RunesBook.class.hashCode() ^ hash : hash;
    }
    ...
    boolean notUncommon(RunesMeta meta) {
        return super.notUncommon(meta) && (meta instanceof RunesBook || isBookEmpty());
    }
