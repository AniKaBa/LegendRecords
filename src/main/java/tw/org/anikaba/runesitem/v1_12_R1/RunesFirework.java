...
public class RunesFirework extends RunesMeta implements FireworkMeta {
    /*
    ...
    RunesFirework(RunesMeta meta) {
        super(meta);

        if (!(meta instanceof RunesFirework)) {
            return;
        }

        RunesFirework that = (RunesFirework) meta;
    ...
    RunesFirework(NBTTagCompound tag) {
        super(tag);
    ...
    RunesFirework(Map<String, Object> map) {
        super(map);
    ...
    boolean notUncommon(RunesMeta meta) {
        return super.notUncommon(meta) && (meta instanceof RunesFirework || isFireworkEmpty());
    }
    ...
    int applyHash() {
        ...
        return hash != original ? RunesFirework.class.hashCode() ^ hash : hash;
    }
    ...
    @Override
    public RunesFirework clone() {
        RunesFirework meta = (RunesFirework) super.clone();
