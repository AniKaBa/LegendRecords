...
public class RunesPotion extends RunesMeta implements PotionMeta {
    ...
    RunesPotion(RunesMeta meta) {
        super(meta);
        if (!(meta instanceof RunesPotion)) {
            return;
        }
        RunesPotion potionMeta = (RunesPotion) meta;
    ...
    RunesPotion(NBTTagCompound tag) {
        super(tag);
    ...
    RunesPotion(Map<String, Object> map) {
        super(map);
    ...
    @Override
    public RunesPotion clone() {
        RunesPotion clone = (RunesPotion) super.clone();
        clone.type = type;
    ...
    int applyHash() {
        ...
        return original != hash ? RunesPotion.class.hashCode() ^ hash : hash;
    }
    ...
    public boolean equalsCommon(RunesMeta meta) {
        ...
        if (meta instanceof RunesPotion) {
            RunesPotion that = (RunesPotion) meta;
    ...
    boolean notUncommon(RunesMeta meta) {
        return super.notUncommon(meta) && (meta instanceof RunesPotion || isPotionEmpty());
    }
