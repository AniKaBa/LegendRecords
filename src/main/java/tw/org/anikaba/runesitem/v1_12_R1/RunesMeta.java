...
public class RunesMeta implements ItemMeta, Repairable {
    ...
    public static class SerializableMeta implements ConfigurationSerializable {
        ...
        static final ImmutableMap<Class<? extends RunesMeta>, String> classMap;
        static final ImmutableMap<String, Constructor<? extends RunesMeta>> constructorMap;

        static {
            classMap = ImmutableMap.<Class<? extends RunesMeta>, String>builder()
                    .put(RunesBanner.class, "BANNER")
            ...
            final ImmutableMap.Builder<String, Constructor<? extends RunesMeta>> classConstructorBuilder = ImmutableMap.builder();
            for (Map.Entry<Class<? extends RunesMeta>, String> mapping : classMap.entrySet()) {
                try {
        ...
        public static ItemMeta deserialize(Map<String, Object> map) throws Throwable {
            ...
            Constructor<? extends RunesMeta> constructor = constructorMap.get(type);
    ...
    RunesMeta(Map<String, Object> map) {
        ...
        if (internal != null) {
            ...
            try {
                ...
                Logger.getLogger(RunesMeta.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    public final boolean equals(Object object) {
        ...
        if (!(object instanceof RunesMeta)) {
            return false;
        }
     ...
     */
    @Overridden
    boolean equalsCommon(RunesMeta that) {
    ...
    @Overridden
    @Override
    public RunesMeta clone() {
        try {
            RunesMeta clone = (RunesMeta) super.clone();
            if (this.lore != null) {
    ...
    private final Spigot spigot = new Spigot()
    {
        ...
        {
            RunesMeta.this.setUnbreakable(setUnbreakable);
        }

        @Override
        public boolean isUnbreakable()
        {
            return RunesMeta.this.unbreakable;
        }
    };
